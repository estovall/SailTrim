...
- The Buoy: a build piece under the hammer's Misc tab, 6 wood and 2 resin, no workbench needed. Place it on open water like a boat; it floats on the waves, keeps the spot it was set at, and its lantern burns at night (`BuoyLight`). It stays in the world out to the game's distant area, hundreds of metres, and its lantern glass shows as a bright point at night from that far. Press E at a buoy to change its colour (red, green, yellow, white, blue, orange, black: pennant and hoop), and every loaded buoy shows on the map as a small disc in that colour (`BuoyPins`). Line them up for a channel or a race course. A boat that hits one shoves it aside for a moment; it works its way back.
