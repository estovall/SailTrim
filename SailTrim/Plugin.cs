...
namespace SailTrim
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        private void BindConfig()
        {
            ...
            GangwayShipTimber = Config.Bind("10. Gangway", "GangwayShipTimber", true,
                "Finish the gangway in the timber the hull itself wears rather than a building's. A building piece's material varies itself by where it stands, which is fixed for a house and different every frame for a boat, and the gangway flickered as the hull moved under it.");
