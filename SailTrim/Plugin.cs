...
namespace SailTrim
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        internal static ConfigEntry<bool> CoastLog;
        ...
        internal static ConfigEntry<bool> GangwayRefund;
        ...
        private void BindConfig()
        {
            ...
            CoastLog = Config.Bind("11. Development", "CoastLog", false,
                "Write a line to the log four times a second while an empty boat is carrying her way, saying how fast she is going and whether the coast is running. For working out why she stops when she should not.");
            ...
            GangwayRetractDelay = Config.Bind("10. Gangway", "GangwayRetractDelay", 2f,
                new ConfigDescription("Seconds at the helm before a gangway that is still down comes up by itself.",
                    new AcceptableValueRange<float>(0f, 10f)));
            GangwayRefund = Config.Bind("10. Gangway", "GangwayRefund", true,
                "A boat that breaks up drops the gangways that were fitted to it. They are fittings you made and carried aboard rather than part of the hull, so losing the boat need not also cost you the fine wood and iron nails in them.");
        ...
        private static bool VerifyPatchTargets()
        {
            var targets = new List<MethodTarget>
            {
                ...
                new MethodTarget(typeof(WearNTear), nameof(WearNTear.Damage), new[] { typeof(HitData) }),
                new MethodTarget(typeof(WearNTear), "RPC_Damage", new[] { typeof(long), typeof(HitData) }),
                new MethodTarget(typeof(WearNTear), nameof(WearNTear.ApplyDamage), new[] { typeof(float), typeof(HitData) }),
